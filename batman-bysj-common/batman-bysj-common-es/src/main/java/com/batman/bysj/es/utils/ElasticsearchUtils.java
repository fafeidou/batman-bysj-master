package com.batman.bysj.es.utils;
...
public class ElasticsearchUtils {
     ...
     * 批量插入（每次插入100000条）
     */
    public static void createManyDates(List<Map<String, Object>> mapList) {
        String index = "import_index";
        ...
        mapList.forEach(i -> {
            ...
            map.put("item_title", i.get("product_id"));
            map.put("item_price", i.get("store_code"));
            map.put("id", UUID.randomUUID().toString());
            map.put("item_category_name", i.get("brand_id"));
            map.put("item_image", i.get("category_code_4"));
            bulkRequestBuilder.add(client.prepareIndex(index, type, count + "").setSource(map));
            if (count.get() % 1000 == 0) {
