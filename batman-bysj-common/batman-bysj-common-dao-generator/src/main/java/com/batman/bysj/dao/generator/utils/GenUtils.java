package com.batman.bysj.dao.generator.utils;

import com.batman.bysj.dao.generator.config.Constant;
import com.batman.bysj.dao.generator.domain.ColumnDO;
import com.batman.bysj.dao.generator.domain.TableDO;
...
//        templates.add("templates/common/generator/edit.js.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("classname", tableDO.getClassname());
        map.put("pathName", config.getString("model_package").substring(config.getString("model_package").lastIndexOf(".") + 1));
        map.put("columns", tableDO.getColumns());
        map.put("model_package", config.getString("model_package"));
        map.put("dao_package", config.getString("dao_package"));
        ...
        for (String template : templates) {
            ...
            try {
                ...
                zip.putNextEntry(new ZipEntry(getFileName(template, tableDO.getClassname(), tableDO.getClassName(),
                        config.getString("model_package").substring(config.getString("model_package").lastIndexOf(".") + 1))));
