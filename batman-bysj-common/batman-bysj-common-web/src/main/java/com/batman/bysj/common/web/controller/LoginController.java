...
public class LoginController {
    ...
    @GetMapping(value = UrlConstants.UserUrl.LOGIN)
    public String login() {
        return "login1";
    }

    @PostMapping(value = UrlConstants.UserUrl.LOGIN)
    public String login(@Valid UserInfoX user, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
